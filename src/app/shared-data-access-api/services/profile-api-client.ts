...
import { FollowUserByUsername$Params, followUserByUsername } from '../fn/profile/follow-user-by-username';
import { GetProfileByUsername$Params, getProfileByUsername } from '../fn/profile/get-profile-by-username';
import { UnfollowUserByUsername$Params, unfollowUserByUsername } from '../fn/profile/unfollow-user-by-username';
...
export class ProfileApiClient extends BaseApiClient {
     ...
     */
    getProfileByUsername$Response(
        params: GetProfileByUsername$Params,
        context?: HttpContext
    ): Observable<
        StrictHttpResponse<{
            profile: Profile;
     ...
     * This method doesn't expect any request body.
     */
    unfollowUserByUsername$Response(
        params: UnfollowUserByUsername$Params,
        context?: HttpContext
    ): Observable<
        StrictHttpResponse<{
            profile: Profile;
