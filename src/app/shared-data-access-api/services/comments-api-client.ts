...
import { CreateArticleComment$Params, createArticleComment } from '../fn/comments/create-article-comment';
import { DeleteArticleComment$Params, deleteArticleComment } from '../fn/comments/delete-article-comment';
import { GetArticleComments$Params, getArticleComments } from '../fn/comments/get-article-comments';
...
export class CommentsApiClient extends BaseApiClient {
     ...
     */
    getArticleComments$Response(
        params: GetArticleComments$Params,
        context?: HttpContext
    ): Observable<
        StrictHttpResponse<{
     ...
     */
    createArticleComment$Response(
        params: CreateArticleComment$Params,
        context?: HttpContext
    ): Observable<
        StrictHttpResponse<{
            comment: Comment;
     ...
     * This method doesn't expect any request body.
     */
    deleteArticleComment$Response(
        params: DeleteArticleComment$Params,
        context?: HttpContext
