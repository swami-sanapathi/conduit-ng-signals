...
import { CreateArticleFavorite$Params, createArticleFavorite } from '../fn/favorites/create-article-favorite';
import { DeleteArticleFavorite$Params, deleteArticleFavorite } from '../fn/favorites/delete-article-favorite';
...
export class FavoritesApiClient extends BaseApiClient {
     ...
     */
    createArticleFavorite$Response(
        params: CreateArticleFavorite$Params,
        context?: HttpContext
    ): Observable<
        StrictHttpResponse<{
            article: Article;
     ...
     * This method doesn't expect any request body.
     */
    deleteArticleFavorite$Response(
        params: DeleteArticleFavorite$Params,
        context?: HttpContext
    ): Observable<
        StrictHttpResponse<{
            article: Article;
