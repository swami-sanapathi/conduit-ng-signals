...
import { CreateArticle$Params, createArticle } from '../fn/articles/create-article';
import { DeleteArticle$Params, deleteArticle } from '../fn/articles/delete-article';
import { GetArticle$Params, getArticle } from '../fn/articles/get-article';
import { GetArticles$Params, getArticles } from '../fn/articles/get-articles';
import { GetArticlesFeed$Params, getArticlesFeed } from '../fn/articles/get-articles-feed';
import { UpdateArticle$Params, updateArticle } from '../fn/articles/update-article';
...
export class ArticlesApiClient extends BaseApiClient {
     ...
     */
    getArticlesFeed$Response(
        params?: GetArticlesFeed$Params,
        context?: HttpContext
    ): Observable<
        StrictHttpResponse<{
    ...
    deleteArticle(params: DeleteArticle$Params, context?: HttpContext): Observable<void> {
        return this.deleteArticle$Response(params, context).pipe(map((r: StrictHttpResponse<void>): void => r.body));
    }
}
