...
import { CreateUser$Params, createUser } from '../fn/user-and-authentication/create-user';
import { GetCurrentUser$Params, getCurrentUser } from '../fn/user-and-authentication/get-current-user';
import { Login$Params, login } from '../fn/user-and-authentication/login';
import { UpdateCurrentUser$Params, updateCurrentUser } from '../fn/user-and-authentication/update-current-user';
...
export class UserAndAuthenticationApiClient extends BaseApiClient {
    ...
    updateCurrentUser$Response(
        params: UpdateCurrentUser$Params,
        context?: HttpContext
    ): Observable<
        StrictHttpResponse<{
            user: User;
